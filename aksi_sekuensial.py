...
print(f"Selamat datang {nama} dalam program Python, per 2026 umur anda adaalh {umur} tahun.\n")
...
Selamat datang Evans dalam program Python, per 2026 umur Anda adalah 18 tahun.
